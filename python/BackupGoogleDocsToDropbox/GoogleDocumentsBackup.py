...
# IMPORTANT NOTE: Replace "YOURACCOUNT" in the import statement below with the name of your Temboo account.
from temboo.YOURACCOUNT.MyTemboo import MyTemboo
...
class GoogleDocumentsBackup:
    ...
    def __init__(self):
        ...
        """
        self.session = MyTemboo(TEMBOO_APPLICATIONKEY_NAME, 
