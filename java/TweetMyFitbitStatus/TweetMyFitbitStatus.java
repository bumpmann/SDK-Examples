...
public class TweetMyFitbitStatus {
	...
	private static final String FIBIT_OAUTH_CONSUMER_KEY = "YOUR FITBIT OAUTH CONSUMER KEY";
	private static final String FITBIT_OAUTH_CONSUMER_SECRET = "YOUR FITBIT OAUTH CONSUMER SECRET";
	private static final String FITBIT_OAUTH_TOKEN = "YOUR FITBIT OAUTH TOKEN";
	private static final String FITBIT_OAUTH_TOKEN_SECRET = "YOUR FITBIT OAUTH TOKEN SECRET";
	...
	private static final String TWITTER_OAUTH_CONSUMER_KEY = "YOUR TWITTER OAUTH CONSUMER KEY";
	private static final String TWITTER_OAUTH_CONSUMER_SECRET = "YOUR TWITTER OAUTH CONSUMER SECRET";
	...
	*/
	public static void main(String args[]) throws Exception {
		...
		getTimeSeriesInput.set_OauthConsumerKey(FIBIT_OAUTH_CONSUMER_KEY);
		getTimeSeriesInput.set_OauthConsumerSecret(FITBIT_OAUTH_CONSUMER_SECRET);
		getTimeSeriesInput.set_OauthToken(FITBIT_OAUTH_TOKEN);
		getTimeSeriesInput.set_OauthTokenSecret(FITBIT_OAUTH_TOKEN_SECRET);          
	...
	*/ 
	private static void createTweet(TembooSession session, String message) throws TembooException {
		...
		statusesUpdateInput.set_OauthConsumerKey(TWITTER_OAUTH_CONSUMER_KEY);
		statusesUpdateInput.set_OauthConsumerSecret(TWITTER_OAUTH_CONSUMER_SECRET);
		statusesUpdateInput.set_OauthToken(TWITTER_OAUTH_TOKEN);
		statusesUpdateInput.set_OauthTokenSecret(TWITTER_OAUTH_TOKEN_SECRET);          
