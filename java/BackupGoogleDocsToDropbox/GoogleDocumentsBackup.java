package BackupGoogleDocsToDropbox;
...
public class GoogleDocumentsBackup {
	...
	private static final String DROPBOX_OAUTH_CONSUMER_KEY = "YOUR KEY";
	private static final String DROPBOX_OAUTH_CONSUMER_SECRET = "YOUR SECRET";
	private static final String DROPBOX_OAUTH_TOKEN = "YOUR TOKEN";
	private static final String DROPBOX_OAUTH_TOKEN_SECRET = "YOUR TOKEN SECRET";
	...
	public static void main(String[] args) throws Exception {
		...
		createFolderInput.set_OauthConsumerKey(DROPBOX_OAUTH_CONSUMER_KEY);
		createFolderInput.set_OauthConsumerSecret(DROPBOX_OAUTH_CONSUMER_SECRET);
		createFolderInput.set_OauthToken(DROPBOX_OAUTH_TOKEN);
		createFolderInput.set_OauthTokenSecret(DROPBOX_OAUTH_TOKEN_SECRET);
