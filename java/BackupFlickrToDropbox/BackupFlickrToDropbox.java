...
public class BackupFlickrToDropbox {
	...
	private static final String FLICKR_OAUTH_CONSUMER_KEY = "YOUR FLICKR OAUTH CONSUMER KEY";
	private static final String FLICKR_OAUTH_CONSUMER_SECRET = "YOUR FLICKR OAUTH CONSUMER SECRET";
	private static final String FLICKR_OAUTH_TOKEN = "YOUR FLICKR OAUTH TOKEN";
	private static final String FLICKR_OAUTH_TOKEN_SECRET = "YOUR FLICKER OAUTH TOKEN SECRET";
	...
	private static final String DROPBOX_OAUTH_CONSUMER_KEY = "YOUR DROPBOX CONSUMER KEY";
	private static final String DROPBOX_OAUTH_CONSUMER_SECRET = "YOUR DROPBOX CONSUMER SECRET";
	private static final String DROPBOX_OAUTH_TOKEN = "YOUR DROPBOX OAUTH TOKEN";
	private static final String DROPBOX_OAUTH_TOKEN_SECRET = "YOUR DROPBOX OAUTH TOKEN SECRET";
	...
	public static void main(String[] args) throws Exception {
		...
		getListInput.set_OauthConsumerKey(FLICKR_OAUTH_CONSUMER_KEY);
		getListInput.set_OauthConsumerSecret(FLICKR_OAUTH_CONSUMER_SECRET);
		getListInput.set_OauthToken(FLICKR_OAUTH_TOKEN);
		getListInput.set_OauthTokenSecret(FLICKR_OAUTH_TOKEN_SECRET);
		...
		for(int num1=0; num1 < photoSet.getLength(); num1++) {			
			...
			getPhotosInput.set_PhotoSetID(photoSetID);
			getPhotosInput.set_OauthConsumerKey(FLICKR_OAUTH_CONSUMER_KEY);
			getPhotosInput.set_OauthConsumerSecret(FLICKR_OAUTH_CONSUMER_SECRET);
			getPhotosInput.set_OauthToken(FLICKR_OAUTH_TOKEN);
			getPhotosInput.set_OauthTokenSecret(FLICKR_OAUTH_TOKEN_SECRET);
			...
			for(int num2=0; num2 < photos.getLength(); num2++) {			
				...
				getImageInput.set_FarmID(farm);
				getImageInput.set_PhotoID(photoID);
				getImageInput.set_Secret(secret);
				getImageInput.set_ServerID(server);
				...
				uploadInput.set_OauthConsumerKey(DROPBOX_OAUTH_CONSUMER_KEY);
				uploadInput.set_OauthConsumerSecret(DROPBOX_OAUTH_CONSUMER_SECRET);
				uploadInput.set_OauthToken(DROPBOX_OAUTH_TOKEN);
				uploadInput.set_OauthTokenSecret(DROPBOX_OAUTH_TOKEN_SECRET);
