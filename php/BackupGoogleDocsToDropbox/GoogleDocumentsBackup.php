...
*/
	...
	try {
		...
		$session = new MyTemboo($TEMBOO_APPLICATIONKEY_NAME, $TEMBOO_APPLICATIONKEY);
		...
		$createFolderInput->setOauthConsumerKey($DROPBOX_OAUTH_CONSUMER_KEY);
		$createFolderInput->setOauthConsumerSecret($DROPBOX_OAUTH_CONSUMER_SECRET);
		$createFolderInput->setOauthToken($DROPBOX_OAUTH_TOKEN);
		$createFolderInput->setOauthTokenSecret($DROPBOX_OAUTH_TOKEN_SECRET);
	...
	function uploadFileToDropbox($session, $fileContents, $fileTitle)
	{
		...
		$uploadInput->setOauthConsumerKey($DROPBOX_OAUTH_CONSUMER_KEY);
		$uploadInput->setOauthConsumerSecret($DROPBOX_OAUTH_CONSUMER_SECRET);
		$uploadInput->setOauthToken($DROPBOX_OAUTH_TOKEN);
		$uploadInput->setOauthTokenSecret($DROPBOX_OAUTH_TOKEN_SECRET);
